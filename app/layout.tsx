...
export const metadata: Metadata = {
  title: "Объединенная цирковая студия — Воздушная гимнастика",
  description:
    "Цирковая студия нового формата. Воздушная гимнастика, жонглирование, акробатика, конкурсы, фестивали, концерты.",
};
